 ...
 */
final class Version20220626171344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE aliment (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, unit_id INT NOT NULL, name VARCHAR(255) NOT NULL, pretty_name VARCHAR(255) NOT NULL, INDEX IDX_70FF972B12469DE2 (category_id), INDEX IDX_70FF972BF8BD700D (unit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
